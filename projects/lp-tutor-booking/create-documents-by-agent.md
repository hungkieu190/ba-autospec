...
`projects/lp-tutor-booking/output/`
...
Tạo thư mục `projects/lp-tutor-booking/output/` nếu chưa có, rồi tạo đúng 7 file tài liệu chính sau:
...
- `projects/lp-tutor-booking/output/index.md`
- `projects/lp-tutor-booking/output/quality-report.md`
- `projects/lp-tutor-booking/output/asana-task.html`
...
Tạo thêm file `projects/lp-tutor-booking/output/asana-task.html` để người dùng mở trong trình duyệt, bấm copy, rồi paste vào Asana task.
