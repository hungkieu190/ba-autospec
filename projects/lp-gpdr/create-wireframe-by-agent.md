...
Vẽ **đầy đủ các màn hình / step** của product `lp-gpdr` thành **nhiều file HTML5 + Tailwind CSS riêng lẻ** (không all-in-one), có:
...
1. Tài liệu `projects/lp-gpdr/output/`
2. `input.md` / `questions.md`
3. Ảnh `projects/lp-gpdr/output/images-demo/` (nếu có)
...
2. `projects/lp-gpdr/questions.md` (nếu có)
3. Main docs:

- `projects/lp-gpdr/output/01-discovery.md`
- `projects/lp-gpdr/output/02-product-strategy.md`
- `projects/lp-gpdr/output/03-prd.md`
- `projects/lp-gpdr/output/04-ux-and-wireframe.md`
- `projects/lp-gpdr/output/05-qa-and-documentation.md`
- `projects/lp-gpdr/output/06-seo-and-marketing.md`
- `projects/lp-gpdr/output/07-build-or-not-build.md`

4. Ưu tiên sâu:
   - `projects/lp-gpdr/output/03-prd.md`
   - `projects/lp-gpdr/output/04-ux-and-wireframe.md`
   - `projects/lp-gpdr/output/02-product-strategy.md`
   - `projects/lp-gpdr/output/index.md`

### Ảnh tham chiếu (images-demo)

Thư mục: `projects/lp-gpdr/output/images-demo/`
...
```text
projects/lp-gpdr/output/wireframes/
...
- Output root: `projects/lp-gpdr/output/wireframes/`
