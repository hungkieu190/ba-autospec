...
`projects/lp-gpdr/output/`

## Files bắt buộc phải đọc

1. `projects/lp-gpdr/input.md`
2. `projects/lp-gpdr/questions.md`
...
Tạo thư mục `projects/lp-gpdr/output/` nếu chưa có, rồi tạo đúng 7 file tài liệu chính sau:
...
- `projects/lp-gpdr/output/quality-report.md`
- `projects/lp-gpdr/output/asana-task.html`
...
Tạo thêm file `projects/lp-gpdr/output/asana-task.html` để người dùng mở trong trình duyệt, bấm copy, rồi paste vào Asana task.
