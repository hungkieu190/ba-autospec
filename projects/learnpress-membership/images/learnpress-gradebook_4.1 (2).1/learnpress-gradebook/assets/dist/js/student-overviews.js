...
(() => {
/*!***************************************************************************************************!*\
  !*** ../../../../learnpress-addons/4.x.x/learnpress-gradebook/assets/src/js/student-overviews.js ***!
  \***************************************************************************************************/
__webpack_require__.r(__webpack_exports__);
...
document.addEventListener('click', function (e) {
  var target = e.target;
  if (target.classList.contains('gradebook-search-button')) {
    filter(e, target);
  } else if (target.classList.contains('gradebook-reset-button')) {
    var gradebookSearchForm = target.closest('.lp-gradebook-filter');
...
document.addEventListener('reset', function (e) {
  if (e.target.classList.contains('gradebook-search-user')) {
...
/******/ })()
;
//# sourceMappingURL=student-overviews.js.map