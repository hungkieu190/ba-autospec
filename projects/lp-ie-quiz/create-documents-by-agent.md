...
`projects/lp-ie-quiz/output/`

## Files bắt buộc phải đọc

1. `projects/lp-ie-quiz/input.md`
2. `projects/lp-ie-quiz/questions.md`
...
Tạo thư mục `projects/lp-ie-quiz/output/` nếu chưa có, rồi tạo đúng 7 file tài liệu chính sau:
...
- `projects/lp-ie-quiz/output/quality-report.md`
- `projects/lp-ie-quiz/output/asana-task.html`
...
Tạo thêm file `projects/lp-ie-quiz/output/asana-task.html` để người dùng mở trong trình duyệt, bấm copy, rồi paste vào Asana task.
