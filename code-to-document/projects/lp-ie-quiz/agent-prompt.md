...
2. WRITE ONLY under: `projects/lp-ie-quiz/output/`
...
5. Produce BOTH:
   - `projects/lp-ie-quiz/output/product-request.vi.md` (Vietnamese, for human review)
   - `projects/lp-ie-quiz/output/product-request.en.md` (English, FINAL)
...
- Project slug: `lp-ie-quiz`
- Project title: `Learnpress Import Export Quiz`
- User input: `projects/lp-ie-quiz/input.md`
- Code reference: `code/`
- Skills lib: `skills/`
- Output schema: `sample-request.md`
- Write to: `projects/lp-ie-quiz/output/`
...
- Read `projects/lp-ie-quiz/input.md`
...
Create/overwrite:
1. `projects/lp-ie-quiz/output/product-request.en.md`
2. `projects/lp-ie-quiz/output/product-request.vi.md`
...
- slug: lp-ie-quiz
- title: Learnpress Import Export Quiz
- created: 2026-07-14T02:14:22.279Z
